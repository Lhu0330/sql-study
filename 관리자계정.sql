...
--
--CREATE USER ORCLSTUDY ACCOUNT UNLOCK IDENTIFIED BY oracle;
--grant connect, resource, create table to orclstudy; 
--revoke connect from orclstudy;
--
--ALTER USER ORCLSTUDY ACCOUNT UNLOCK IDENTIFIED BY orcl;
--
--drop user orclstudy;
